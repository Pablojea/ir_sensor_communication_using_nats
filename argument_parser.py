...
def parse() -> (str, int, []):
    ...
    parser.add_argument('-i', '--interval',
                        type=float,
                        default=2.0,
                        help="Time elapsed between sensor data packages sent. Type = float")

    parser.add_argument('-r', '--range',
                        type=int,
                        nargs=2,
                        default=[0, 50],
                        help="Minimun and maximum values that can be generated by the mockup sensor. Must receive 2 int values")
